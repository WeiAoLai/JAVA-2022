...
public class DemoScrollBarUI_Pink extends BasicScrollBarUI {
    ...
    // 手柄颜色
    private static final Color thumbColorFrom = new Color(245, 158, 187);// (175, 210, 252);
    private static final Color thumbColorTo = new Color(255, 250, 240);

    // 滑道颜色
    private static final Color backColorFrom = new Color(245, 158, 187);
    private static final Color backColorTo = new Color(249, 229, 230);
    ...
    public static void main(String[] args) {
        ...
        scrollPane.getVerticalScrollBar().setUI(new DemoScrollBarUI_Pink());
