...
public class DemoScrollBarUI_Blue extends BasicScrollBarUI {
    ...
    // 手柄颜色
    private static final Color thumbColorFrom = new Color(175, 210, 252);
    private static final Color thumbColorTo = new Color(150, 250, 225);

    // 滑道颜色
    private static final Color backColorFrom = new Color(175, 210, 252); // (100, 100, 150);
    private static final Color backColorTo = new Color(143, 252, 214);
    ...
    public static void main(String[] args) {
        ...
        scrollPane.getVerticalScrollBar().setUI(new DemoScrollBarUI_Blue());
