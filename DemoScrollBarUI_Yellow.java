...
public class DemoScrollBarUI_Yellow extends BasicScrollBarUI {
    ...
    // 手柄颜色
    private static final Color thumbColorFrom = new Color(234, 235, 221);// (175, 210, 252);
    private static final Color thumbColorTo = new Color(235, 192, 186);

    // 滑道颜色
    private static final Color backColorFrom = new Color(234, 235, 221);
    private static final Color backColorTo = new Color(235, 192, 186);
    ...
    public static void main(String[] args) {
        ...
        scrollPane.getVerticalScrollBar().setUI(new DemoScrollBarUI_Yellow());
